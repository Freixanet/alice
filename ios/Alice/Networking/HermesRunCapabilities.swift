...
extension HermesClient.Manifest {
    /// Hermes 0.21 can advertise a high-level `runs` flag or the three lower
    /// level run endpoints. Treat both shapes as the same capability, matching
    /// the web client's contract parser.

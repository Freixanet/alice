...
const en = {
  ...
  "settings.keywords.general": "appearance design experimental theme light dark text size color accent compact focus language",
  ...
  "settings.designModeHint": "Compare the current look with the anti-slop experiment.",
  "settings.designClassic": "Original",
  "settings.designExperimental": "Experimental",
  ...
  "connect.description": "Paste your Hermes address and key. Local or on the internet: Alice figures it out.",
  "connect.address": "Address",
  "connect.addressPlaceholder": "https://your-hermes or http://127.0.0.1:8642",
  "connect.key": "Key",
  "connect.keyPlaceholder": "Your Hermes key",
  "connect.keyConnected": "Already connected — paste another to change",
...
const es: Record<MsgKey, string> = {
  ...
  "settings.keywords.general": "apariencia diseño experimental tema claro oscuro texto tamaño color acento compacto foco idioma language",
  ...
  "settings.designMode": "Diseño",
  "settings.designModeHint": "Compara el aspecto actual con el experimento anti-slop.",
  "settings.designClassic": "Original",
  "settings.designExperimental": "Experimental",
  ...
  "connect.description": "Pega la dirección de tu Hermes y la clave. Local o en internet: Alice lo deduce.",
  "connect.address": "Dirección",
  "connect.addressPlaceholder": "https://tu-hermes o http://127.0.0.1:8642",
  "connect.key": "Clave",
  "connect.keyPlaceholder": "La clave de tu Hermes",
  "connect.keyConnected": "Ya conectado — pega otra para cambiar",
  "connect.checking": "Comprobando…",
  "connect.connect": "Conectar",
  "connect.reconnect": "Volver a conectar",
